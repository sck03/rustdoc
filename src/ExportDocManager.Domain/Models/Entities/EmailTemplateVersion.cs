...
namespace ExportDocManager.Models.Entities
{
    public sealed class EmailTemplateVersion
    {
        ...
        [Required, MaxLength(20)] public string Status { get; set; } = TemplateLifecycleStatusCatalog.Draft;
        [Required, MaxLength(20)] public string ShareScope { get; set; } = TemplateShareScopeCatalog.Private;
