...
const presentations: Record<ProductEdition, ProductEditionPresentation> = {
  Document: {
    edition: "Document",
    productName: "出口单证管理系统",
    editionName: "单证员版",
    loginTagline: "单证业务工作台",
    englishName: "Export Document Manager",
    defaultRoute: "/dashboard",
  },
  Sales: {
    edition: "Sales",
    productName: "外贸业务管理系统",
    editionName: "业务员版",
    loginTagline: "客户与销售工作台",
    englishName: "Foreign Trade Sales Manager",
  ...
  Full: {
    ...
    englishName: "Foreign Trade Business Suite",
    defaultRoute: "/dashboard",
  },
};
