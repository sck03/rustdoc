...
namespace ExportDocManager.Api.Tests
{
    public class ApiMasterDataTests
    {
        ...
        public void MasterDataDtoFactory_ShouldMapProductPortUnitAndPayee()
        {
            ...
            var port = new Port { Id = 11, NameEN = "Shanghai", NameCN = "Shanghai CN", Country = "CN", Code = "CNSHA" };
            var unit = new Unit { Id = 12, NameEN = "PCS", NameCN = "Piece CN", Code = "PCE" };
            var payee = new Payee { Id = 13, Category = "Factory", Name = "Payee", BankName = "Bank" };
        ...
        public void MasterDataDtoFactory_ShouldConvertDtosForSave()
        {
            ...
            var port = ApiMasterDataDtoFactory.ToPortForSave(new ApiPortDto(9, "Shanghai", "上海", "CN", "CNSHA"));
            var unit = ApiMasterDataDtoFactory.ToUnitForSave(new ApiUnitDto(10, "PCS", "件", "PCE"));
