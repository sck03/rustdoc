...
import {
  getStableDotnetSdkChannel,
  isDotnetSdkVersionCompatible,
} from "./lib/dotnet-sdk-compatibility.mjs";
...
assert.equal(isDotnetSdkVersionCompatible("10.0.302", "10.0.400", "latestFeature"), true);
...
assert.equal(isDotnetSdkVersionCompatible("10.0.302", "10.1.100", "latestFeature"), false);
assert.equal(isDotnetSdkVersionCompatible("10.0.302", "11.0.100", "latestFeature"), false);
assert.equal(isDotnetSdkVersionCompatible("10.0.302", "10.0.400-preview.1", "latestFeature"), false);
...
assert.equal(getStableDotnetSdkChannel("10.0.302"), "10.0.x");
assert.equal(getStableDotnetSdkChannel("10.0.400"), "10.0.x");
assert.equal(getStableDotnetSdkChannel("10.0.400-preview.1"), null);
assert.equal(getStableDotnetSdkChannel("not-a-version"), null);
