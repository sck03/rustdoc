    ...
    public static partial class ApiMasterDataDtoFactory
    {
        ...
        public static ApiProductDto FromProduct(Product product)
        {
            ...
            return new ApiProductDto(
                ...
                product.Width,
                product.Height,
                ItemMeasurementPrecisionPolicy.RoundWeight(product.GWPerCtn),
                ItemMeasurementPrecisionPolicy.RoundWeight(product.NWPerCtn),
                product.PcsPerCtn,
        ...
        public static Product ToProductForSave(ApiProductDto dto)
        {
            ...
            return new Product
            {
                ...
                Width = dto.Width,
                Height = dto.Height,
                GWPerCtn = ItemMeasurementPrecisionPolicy.RoundWeight(dto.GWPerCtn),
                NWPerCtn = ItemMeasurementPrecisionPolicy.RoundWeight(dto.NWPerCtn),
