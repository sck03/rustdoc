    ...
    public static partial class ApiInvoiceDtoFactory
    {
        public static ApiInvoiceDetailDto FromInvoiceDetail(Invoice invoice)
        {
            ...
            return new ApiInvoiceDetailDto
            {
                ...
                NotifyPartyName = invoice.NotifyPartyMode == NotifyPartyMode.Separate ? invoice.NotifyPartyName ?? string.Empty : string.Empty,
                NotifyPartyAddress = invoice.NotifyPartyMode == NotifyPartyMode.Separate ? invoice.NotifyPartyAddress ?? string.Empty : string.Empty,
