import type { ApiInvoiceItemDto, ApiProductDto, ApiUnitDto, ExportDocManagerApiClient, HsCodeKnowledgeFeedbackInput } from "../../api/index.ts";
...
export type InvoiceItemsEditorProps = {
  ...
  blankRowCount?: number; defaultSpareColumnCount?: number; currency: string; exchangeRate?: number | null; focusedWorkbench?: boolean; isProductLibraryBusy: boolean; readOnly?: boolean;
