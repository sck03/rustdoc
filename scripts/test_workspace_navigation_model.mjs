...
assert(device.getWorkspaceDeviceCapabilities("phone").canImportExport === true, "phone keeps import and export access");
assert(device.getWorkspaceDeviceCapabilities("phone").canUseAdvancedTools === true, "phone keeps advanced tools access");
assert(device.getWorkspaceDeviceCapabilities("tablet").canImportExport === true, "tablet keeps import and export access");
assert(device.getWorkspaceDeviceCapabilities("tablet").canUseAdvancedTools === true, "tablet keeps advanced tools access");
...
assert(device.resolveWorkspaceDeviceProfile(true, false, true).capabilities.canImportExport === true, "phone profile keeps file operations with a fine pointer");
