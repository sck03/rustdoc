            ...
            new Dictionary<string, object>
            {
                        ...
                        ["ApiDashboardResponse"] = new
                        {
                            ...
                            required = new[]
                            {
                                ...
                                "totalActiveCount",
                                "periodLabel",
                                "previousMonthlyExportAmount",
                                "previousMonthlyProfit",
                                "previousMonthlyTaxRefund",
                                "monthlyInvoiceCount",
                                "draftCount",
                                "verifiedCount",
                                "completedCount",
                            ...
                            properties = new Dictionary<string, object>
                            {
                                ...
                                ["periodLabel"] = StringProperty("Current dashboard period label."),
                                ["previousMonthlyExportAmount"] = DecimalProperty("Previous month export amount for comparison."),
                                ["previousMonthlyProfit"] = DecimalProperty("Previous month estimated profit for comparison."),
                                ["previousMonthlyTaxRefund"] = DecimalProperty("Previous month tax refund for comparison."),
                                ["monthlyInvoiceCount"] = new { type = "integer", format = "int32" },
                                ["draftCount"] = new { type = "integer", format = "int32" },
                                ["verifiedCount"] = new { type = "integer", format = "int32" },
                                ["completedCount"] = new { type = "integer", format = "int32" },
