  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        title: "中国税则税率",
        fields: [
          { name: "normalTariffRate", label: "普通税率" },
          { name: "preferentialTariffRate", label: "优惠/最惠国税率" },
          { name: "exportTariffRate", label: "出口税率" },
          { name: "consumptionTaxRate", label: "消费税率" },
          { name: "valueAddedTaxRate", label: "增值税率" },
          { name: "rebateRate", label: "出口退税率" },
        ],
      },
      {
        title: "数据来源与有效性",
