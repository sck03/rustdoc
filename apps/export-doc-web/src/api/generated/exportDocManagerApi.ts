...
export interface ApiHsCodeDto {
  ciqEntries?: ApiHsCodeRemoteReferenceEntry[] | null;
  classificationEntries?: ApiHsCodeRemoteReferenceEntry[] | null;
  code: string;
...
export interface ApiHsCodeKnowledgeExamplePage {
  items: HsCodeDeclarationExample[];
  pageNumber: number;
  pageSize: number;
  totalCount: number;
}

export interface ApiHsCodeKnowledgeImportResponse {
  exampleCount: number;
...
export interface AppSettings {
  ai: AISettings;
  batchExport: BatchExportSettings;
  email: EmailConfig;
  excelImport: ExcelImportSettings;
...
export interface ExcelImportSettings {
  ...
  creditCodeCell: string;
  ctnUnitENCol: number;
  currencyCell: string;
  customerAddressLineCount: number;
  customerAddressStartCell: string;
  customerNameCell: string;
  destinationCountryCell: string;
  exporterAddressLineCount: number;
  exporterAddressStartCell: string;
  exporterNameCNCell: string;
  exporterNameCell: string;
  fabricCompositionCol: number;
  gwPerCtnCol: number;
  gwTotalCol: number;
  heightCol: number;
  ...
  issuingBankCell: string;
  itemsEndRow: number;
  itemsStartRow: number;
  lengthCol: number;
  letterOfCreditNoCell: string;
  notifyPartyAddressLineCount: number;
  notifyPartyAddressStartCell: string;
  notifyPartyNameCell: string;
  nwPerCtnCol: number;
  nwTotalCol: number;
  originCol: number;
  paymentTermsCell: string;
  poNumberCol: number;
  portOfDestinationCell: string;
  portOfLoadingCell: string;
  quantityCol: number;
  schemeName: string;
  shippingMarksCell: string;
  styleNameCNCol: number;
  styleNameCol: number;
  styleNoCol: number;
  supervisionModeCell: string;
  totalPriceCol: number;
  tradeTermsCell: string;
  transportModeCell: string;
  unitCNCol: number;
  unitENCol: number;
  unitPriceCol: number;
  volumeCol: number;
...
export interface ExchangeRateSettings {
  ...
  cacheDurationMinutes: number;
  lastCurrencyListUpdateTime?: string | null;
  selectedCurrencies: string[];
  url: string;
}

export interface HsCodeDeclarationExample {
  createdAt: string;
  fingerprint: string;
  id: number;
  ...
  resolvedCurrentHsCode?: string | null;
  searchText: string;
  source: string;
...
export interface HsCodeExampleInput {
  id: number;
  isManuallyVerified?: boolean;
  productName: string;
  rawReportedHsCode: string;
...
export interface HsCodeKnowledgeSearchResponse {
  items: HsCodeKnowledgeSearchResult[];
  localExampleCount: number;
  message: string;
  query: string;
}

export interface HsCodeKnowledgeSearchResult {
  canUse: boolean;
...
export interface HsCodeRemoteCandidate {
  ...
  specification?: string | null;
  suggestedCurrentHsCode?: string | null;
}
...
export interface InvoiceCloneOptions {
...
export interface SingleWindowExportIssue {
  ...
  severity: SingleWindowExportIssueSeverity;
}
...
export interface SingleWindowOperationCenterDetail {
  ...
  draftRevision: number;
  invoiceNo: string;
  lastClientDispatchAt?: string | null;
...
export interface SingleWindowPackageManifest {
  ...
  invoiceNo: string;
  packageId: string;
  packageType: SingleWindowPackageType;
...
export interface SingleWindowReceiptParseResult {
  ...
  occurredAt?: string | null;
  receiptCode: string;
  receiptKind: SingleWindowReceiptKind;
  receiptMessage: string;
  referenceNo: string;
  sourceFileName: string;
}
...
export interface SingleWindowSettings {
...
export interface SystemSettings {
  ...
  postgreSqlAdditionalOptions: string;
  postgreSqlAutoBackupDayOfWeek: number;
  postgreSqlAutoBackupEnabled: boolean;
  postgreSqlAutoBackupRetentionCount: number;
  postgreSqlAutoBackupSchedule: string;
  postgreSqlAutoBackupTime: string;
...
export interface LoginRequest {
  "X-ExportDocManager-Bootstrap-Token"?: string;
...
export interface StageServerMigrationRestoreRequest {
  ...
  "X-ExportDocManager-Migration-Password": string;
  "X-ExportDocManager-Migration-File-Name": string;
  body: Blob;
}
...
export interface UploadAndRestorePostgreSqlPhysicalBackupRequest {
  "X-ExportDocManager-Restore-Confirmation": string;
  "X-ExportDocManager-Sensitive-Operation-Ticket": string;
  "X-ExportDocManager-PostgreSql-Backup-File-Name": string;
  body: Blob;
}
    ...
    return this.request<ApiLoginResponse>("POST", path, {
      ...
      init: {
        ...
        headers: mergeHeaders(init?.headers, {
          "X-ExportDocManager-Bootstrap-Token": request["X-ExportDocManager-Bootstrap-Token"] === undefined ? undefined : String(request["X-ExportDocManager-Bootstrap-Token"]),
        }),
      },
    });
  }
  ...
  public stageServerMigrationRestore(request: StageServerMigrationRestoreRequest, init?: RequestInit): Promise<ApiServerMigrationRestoreResponse> {
    ...
    return this.request<ApiServerMigrationRestoreResponse>("POST", path, {
      ...
      init: {
        ...init,
        headers: mergeHeaders(init?.headers, {
          "X-ExportDocManager-Restore-Confirmation": String(request["X-ExportDocManager-Restore-Confirmation"]),
          "X-ExportDocManager-Sensitive-Operation-Ticket": String(request["X-ExportDocManager-Sensitive-Operation-Ticket"]),
          "X-ExportDocManager-Migration-Password": String(request["X-ExportDocManager-Migration-Password"]),
          "X-ExportDocManager-Migration-File-Name": String(request["X-ExportDocManager-Migration-File-Name"]),
        }),
      },
    });
  }
    ...
    return this.request<ApiServerMigrationRestoreResponse>("POST", path, {
      ...
      init: {
        ...
        headers: mergeHeaders(init?.headers, {
          "X-ExportDocManager-Restore-Confirmation": String(request["X-ExportDocManager-Restore-Confirmation"]),
          "X-ExportDocManager-Sensitive-Operation-Ticket": String(request["X-ExportDocManager-Sensitive-Operation-Ticket"]),
          "X-ExportDocManager-PostgreSql-Backup-File-Name": String(request["X-ExportDocManager-PostgreSql-Backup-File-Name"]),
        }),
      },
    });
  }
...
function mergeHeaders(initHeaders: HeadersInit | undefined, values: Record<string, string | undefined>): Headers {
  const headers = new Headers(initHeaders);
