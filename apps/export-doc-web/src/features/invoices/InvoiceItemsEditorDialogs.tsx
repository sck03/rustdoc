import type { ApiInvoiceItemDto, ApiProductDto, ExportDocManagerApiClient, HsCodeKnowledgeFeedbackInput, HsCodeKnowledgeSearchResult } from "../../api/index.ts";
...
type Props = {
  ...
  onRefresh(): void; onSearch(keyword: string): void; onProductLibraryPageChange(pageNumber: number): void; onProductLibraryPageSizeChange(pageSize: number): void; onCloseHsKnowledge(): void; onApplyHs(patch: Partial<ApiInvoiceItemDto>, result: HsCodeKnowledgeSearchResult, pendingFeedback: HsCodeKnowledgeFeedbackInput): void;
};
