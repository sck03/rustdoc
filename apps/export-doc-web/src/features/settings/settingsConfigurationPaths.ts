export const singleWindowCustomsCooOrgCodePath = ["singleWindow", "customsCooDefaults", "orgCode"];
export const singleWindowCustomsCooFetchPlacePath = ["singleWindow", "customsCooDefaults", "fetchPlace"];
